...
def create_manual_listing(session: Session, owner_id: str, payload: ManualListingInput) -> dict:
    ...
    listing = save_manual_listing(session, owner_id, payload, source, confidence, economics)
