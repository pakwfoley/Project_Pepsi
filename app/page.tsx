...
type ProvisionalValuation = { valuationStatus: 'estimated' | 'available' | 'insufficient_evidence'; valuationMethod: string; currency: 'USD'; fairMarketValue?: ValueRange | null; quickLiquidationValue?: ValueRange | null; tradeValue?: ValueRange | null; confidence: number; liquidity: string; basis: string[]; uncertainties: string[] };
