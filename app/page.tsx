...
type ScannerCandidate = { id: string; url: string; title: string; askCents: number | null; locationText: string; distanceMiles: number | null; imageMetadata: unknown[]; updatedAt: string; reviewPriority: { score: number; posture: string; risk_level: string; valuation_status: string; factors: string[] }; analysis: { identification?: { brand?: string; model?: string; reference?: string; confidence?: number }; recommendation?: string; rationale?: string; questions?: string[]; riskSignals?: string[] } };
